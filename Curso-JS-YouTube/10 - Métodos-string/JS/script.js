...
let roeu = frase.slice(7, 11); // Extraiu a palavra "roeu" da frase
console.log(roeu);

// "replace(search, replace)" => Substitui a primeira ocorrência de uma substring pela outra na string.
let novaFrase = frase.replace("roeu", "não roeu");
...
let novaFrase2 = frase.replaceAll("r", "g");
