...
const calcMediaOne = (noteOne, noteTwo) => {
  const averageGrade = (noteOne + noteTwo) / 2;

  switch (true) {
    case averageGrade >= 7:
      console.log(`Aprovado!`);
      break;
    case averageGrade < 7 && averageGrade >= 5:
...
// Exercício 23 => Escreva um programa onde receberá uma cor do semáforo: "Red", "Green", "Yellow" e retornara uma mensagem do significado desse cor
const semáforoOne = (x) => {
  if (x === "Red") {
    console.log(`${x}: Pare!`);
  } else if (x === "Green") {
